...
with open("dane (1).txt", "r") as file:
    ...
    for line in file:
        if luckyNumbers(int(line), luckyTab) == True:   # sprawdzam każdą liczbę osobno czy jest szczęśliwa
            count += 1


    print("liczb, które są  szczęśliwe jest w pliku: ", count)              # wyświetlam wynik 307
